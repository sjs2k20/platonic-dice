const { RollRecordManager } = require("../../core/History/RollRecordManager");
...
describe("RollRecordManager", () => {
    ...
    const makeModifiedDieRecord = (roll = 5, modified = 7, timestamp = baseDate) => ({
        roll,
        modified,
        timestamp,
    });

    const makeTargetDieRecord = (roll = 3, outcome = Outcome.Success, timestamp = baseDate) => ({
        roll,
        outcome,
        timestamp,
    });
