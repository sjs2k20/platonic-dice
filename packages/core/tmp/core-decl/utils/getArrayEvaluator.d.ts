...
export type TestConditionsArrayInstance = import("../entities/TestConditionsArray").TestConditionsArray;
 ...
 */
export function getArrayEvaluator(tcArray: TestConditionsArrayInstance, modifier?: import("../entities/RollModifier").RollModifierInstance, useNaturalCrits?: boolean): (value: number) => OutcomeValue[];
