 ...
 */
export type Evaluator = (base: number) => import("../entities/Outcome").OutcomeValue;
/**
 ...
 */
export type BuildEvaluator = (dieType: import("../entities/DieType").DieTypeValue, testConditions: ConditionsLike, modifier?: import("../entities/RollModifier").RollModifierInstance, useNaturalCrits?: boolean) => Evaluator;
 ...
 */
export function registerTestType(name: string, { validateShape, buildEvaluator }: {
    validateShape: (c: ConditionsLike) => boolean;
